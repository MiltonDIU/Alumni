...
class AddressesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new AddressResource(Address::with(['division', 'district', 'upazila', 'union', 'created_by'])->get());
    }
    ...
    public function show(Address $address)
    {
        ...
        return new AddressResource($address->load(['division', 'district', 'upazila', 'union', 'created_by']));
    }
