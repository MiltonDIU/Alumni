...
class DesignationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('is_active', function ($row) {
                return $row->is_active ? Designation::IS_ACTIVE_SELECT[$row->is_active] : '';
            });
            $table->editColumn('is_approve', function ($row) {
                return $row->is_approve ? Designation::IS_APPROVE_SELECT[$row->is_approve] : '';
            });
    ...
    public function show(Designation $designation)
    {
        ...
        $designation->load('designationWorks');
