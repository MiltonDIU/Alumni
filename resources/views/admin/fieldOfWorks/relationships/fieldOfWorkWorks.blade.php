...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fieldOfWorkWorks">
                <thead>
                <tr>
                    <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-fieldOfWorkWorks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
