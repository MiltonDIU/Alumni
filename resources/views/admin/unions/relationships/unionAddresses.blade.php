...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-unionAddresses">
                <thead>
                <tr>
                    <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-unionAddresses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
