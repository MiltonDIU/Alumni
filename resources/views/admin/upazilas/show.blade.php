...
@section('content')
    ...
    <div class="card">
        ...
        <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
            <li class="nav-item">
                <a class="nav-link" href="#upazila_unions" role="tab" data-toggle="tab">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#upazila_events" role="tab" data-toggle="tab">
                    {{ trans('cruds.event.title') }}
                </a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="upazila_unions">
                @includeIf('admin.upazilas.relationships.upazilaUnions', ['unions' => $upazila->upazilaUnions])
            </div>
            ...
            <div class="tab-pane" role="tabpanel" id="upazila_events">
                @includeIf('admin.upazilas.relationships.upazilaEvents', ['events' => $upazila->upazilaEvents])
            </div>
        </div>
    </div>
